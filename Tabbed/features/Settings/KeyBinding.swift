...
struct KeyBinding: Codable, Equatable {
    ...
    static let defaultReleaseTab = KeyBinding(modifiers: hyperModifiers, keyCode: keyCodeE)
    ...
    static let defaultCloseTab = KeyBinding(modifiers: hyperModifiers, keyCode: keyCodeW)
