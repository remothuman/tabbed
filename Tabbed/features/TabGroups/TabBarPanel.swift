...
class TabBarPanel: NSPanel {
    ...
    func setContent(
        ...
        onReorderGroupCounters: @escaping ([UUID]) -> Void,
        ...
        onSuperPinnedOrderChanged: @escaping ([CGWindowID]) -> Void,
        ...
        let tabBarView = TabBarView(
            ...
            onReorderGroupCounters: onReorderGroupCounters,
            ...
            onSuperPinnedOrderChanged: onSuperPinnedOrderChanged,
